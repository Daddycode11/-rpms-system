...
$vendors = $pdo->query("SELECT * FROM vendors WHERE status='overdue' ORDER BY vendor_name ASC")->fetchAll(PDO::FETCH_ASSOC);
?>
...
<head>
<meta charset="UTF-8">
<title>Collector Vendors-overdue | RPMS</title>
